...
```{r zipfian-objects-fig, fig.env = "figure", fig.pos = "h", fig.align = "center", fig.width = 2.9, fig.height = 2, fig.cap = "Zipfian distribution of objects handled by each child across sites."}
