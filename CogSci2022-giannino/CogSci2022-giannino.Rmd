...
tbl <- bind_cols(category.counts, top.objects.bycategory) %>%
  select(category...1, Rossel...2, Rossel...5, Tseltal...3, Tseltal...6)

colnames(tbl) <- c("Object Category", "N", "Top objects", "N", "Top objects")

xtable::xtable(tbl,
               row.names = FALSE,
               label = "tab:tab1",
               caption = "Unique object counts and top non-study-related objects for each category across sites.") %>%
    xtable2kable(booktabs = TRUE, escape = FALSE, row.names = NA) %>%
