...
```{r age-effects-fig, fig.env = "figure", fig.pos = "!ht", fig.align = "center", fig.width = 2.4, fig.height = 2.4, fig.cap = "Increase in relative number of transitions between objects per hour with age. Points reflect raw hourly counts for each child, and lines reflect model predictions with shaded standard error regions."}
