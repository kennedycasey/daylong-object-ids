...
p2 <- ggplot(hourly.objects.bycategory, aes(x = object_type, y = n.objects.bysub, color = site, fill = site)) + 
  ...
  geom_point(position = position_jitterdodge(dodge.width = 0.75, jitter.width = 0.1), size = 1) +
...
panels <- plot_grid(ggdraw(fig1[[1]]), ggdraw(fig1[[2]]), nrow = 2)
...
```{r fig2, fig.env = "figure", fig.pos = "h", fig.align = "center", fig.width = 3.4, fig.height = 3.4, fig.cap = "Frequency of handling by object category across different times of day. Point ranges reflect model-predicted mean percentage of handling and 95\\% confidence intervals. Individual points show raw percentages for each child."}
