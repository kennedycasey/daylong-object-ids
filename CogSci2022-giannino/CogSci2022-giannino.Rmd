...
During any given hour, children handled `r hourly.objects$mean` objects, on average (median = `r hourly.objects$median`, _SD_ = `r hourly.objects$sd`, range = `r hourly.objects$min`--`r hourly.objects$max`). 
