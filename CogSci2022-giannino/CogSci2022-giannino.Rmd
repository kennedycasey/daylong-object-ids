...
```{r age-effects-fig, fig.env = "figure", fig.pos = "!ht", fig.align = "center", fig.width = 2.4, fig.height = 2.4, fig.cap = "Relative number of transitions between objects per hour as a function of age. Points reflect raw hourly counts for each child, and lines reflect model predictions with shaded standard error regions."}

# create fig showing increase in objects transitions per hr with age
ggplot() +
