...
We quantify the category distribution of handled objects at two timescales: across the whole waking day (i.e., overall % handling for different object categories across all images) and across individual hours (i.e., number of unique objects from different object categories per hour).
