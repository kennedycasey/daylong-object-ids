...
```
```{r overall-stats-fig, fig.env = "figure*", fig.pos = "!h", fig.align = "center", fig.width = 7, fig.height = 2.7, set.cap.width = TRUE, num.cols.cap = 2, fig.cap = "(A) Overall frequency of handling by object category. Points reflect percentages for individual children. (B) Count of unique objects handled per hour by object category. Points reflect means for individual children across all hours of recording. Asterisks indicate significant differences between sites after correcting for multiple comparisons."}

# eb: tell us what the error bars are (se? 95%ci?) also i'm not sure you need both panels to make the point if you need space (at leaest to me it's not clear that they're making very different points)
...
panels <- plot_grid(ggdraw(fig1[[1]]), ggdraw(fig1[[2]]), nrow = 1, rel_heights = c(1, 1))
