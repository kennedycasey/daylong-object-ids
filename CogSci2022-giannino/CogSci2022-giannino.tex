...
Object Category & Rossel & Tseltal \\ 
  \hline
Food & betelnut, coconut, tuber & bean, tortilla, chips \\ 
  Synthetic & blanket, plastic bottle, woven basket & plastic bag, blanket, bucket \\ 
  Toy & ball, book, swing & toy car, ball, book \\ 
  Natural & stick, leaf, rock & stick, plant, tree \\ 
  Clothing & shirt, purse, skirt & shirt, pants, shoe \\ 
  Mealtime Tool & bowl, spoon, pot & bowl, cup, mug \\ 
  Immovable & stairs, wall, floor & chair, door, fence \\ 
  Work Tool & knife, battery, broom & knife, embroidery ring, broom \\ 
   \hline
\end{tabular}
}
