...
identifiable. In total, 15,942 images were deemed usable by annotators
(Rossel: 9,387, Tseltal: 6,555). One participant had no usable images,
...
\midrule
Food & 54 & bean, tortilla, chips & 38 & betelnut, coconut, tuber\\
Synthetic & 68 & blanket, plastic bag, bucket & 68 & blanket, woven basket, rope\\
Natural & 13 & stick, plant, tree & 21 & stick, leaf, rock\\
Toy & 42 & toy car, ball, book & 21 & ball, book, swing\\
Mealtime Tool & 11 & bowl, cup, baby bottle & 21 & bowl, spoon, knife\\
Clothing & 21 & shirt, pants, shoe & 16 & shirt, skirt, purse\\
Immovable & 19 & chair, door, fence & 21 & stairs, veranda, wall\\
Work Tool & 30 & broom, clothesline, embroidery ring & 16 & knife, broom, baby bathtub\\
NA & NA & NA & 2 & drainage tube, support, NA\\
\bottomrule
\end{tabular}}
\end{table}
...
across sites (\emph{M}\textsubscript{\emph{Rossel}} = 26.5,
\emph{M}\textsubscript{\emph{Tseltal}} = 27.2, \emph{W} = 748.50,
\emph{p} = 0.894). The distribution of handled objects was highly
...
0--32). We exclude from the following analyses, any hour in which a
...
0.04, \emph{t} = 3.95, \emph{p} = 0.000; Figure 5A) and more objects
from different categories per hour (\(\beta\) = 0.07, \emph{SE} = 0.01,
\emph{t} = 5.59, \emph{p} \textless{} 0.001; Figure 5B). These effects
...
\emph{t} = 3.75, \emph{p} = 0.000). However, there was a significant
...
\emph{t} = 3.06, \emph{p} = 0.003), in addition to a marginal main
